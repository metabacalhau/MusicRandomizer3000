...
namespace MusicRandomizer3000.WinForms.Controls
{
    // Copyright http://stackoverflow.com/a/8392100/164770
    ...
    public class BindableComboBox : ComboBox
    {
        ...
        protected override void OnSelectionChangeCommitted(EventArgs e)
        {
            ...
            var bindings = this.DataBindings.Cast<Binding>().Where(x => x.PropertyName == "SelectedItem" && x.DataSourceUpdateMode == DataSourceUpdateMode.OnPropertyChanged);
